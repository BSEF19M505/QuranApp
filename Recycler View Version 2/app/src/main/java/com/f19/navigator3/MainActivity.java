            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem)
            {
                switch (menuItem.getItemId())
                {
                    ...
                    case R.id.nav_repository:
                        Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/BSEF19M505/QuranApp"));
                        startActivity(i);
                    ...
                    case R.id.nav_ayah:
                        ...
                        intent = new Intent(MainActivity.this, SearchAyat.class);
                        startActivity(intent);
                        //drawerLayout.closeDrawer(GravityCompat.START);
                        break;
                    ...
                    case R.id.nav_trans:
                        ...
                        intent = new Intent(MainActivity.this, SearchTranslation.class);
                        startActivity(intent);
                        //drawerLayout.closeDrawer(GravityCompat.START);
                        break;
