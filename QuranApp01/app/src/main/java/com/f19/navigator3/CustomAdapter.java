...
public class CustomAdapter extends BaseAdapter{
    ...
    public View getView(int i, @Nullable View v, @NonNull ViewGroup parent) {
        ...
        TextView name =(TextView) v.findViewById(R.id.txtara);
        TextView roll =(TextView) v.findViewById(R.id.txtur);


        Model student=sm.get(i);

        name.setText(student.getArabic());
        roll.setText(student.getUrdu());
